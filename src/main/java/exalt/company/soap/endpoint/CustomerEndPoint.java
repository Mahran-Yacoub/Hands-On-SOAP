...
import exalt.company.soap.spring_boot_soap.*;
...
public class CustomerEndPoint {
    ...
    public GetAllResponse getCustomers(@RequestPayload GetAllRequest request) {
        ...
        List<Customer> allCustomers = customerRepositoryDB.findAll();
        String allDetails = "";
    ...
    private Customer updateCustomer(Customer customer) {
        ...
        Customer updatedCustomer = customerRepositoryDB.findById(id).get();
        updatedCustomer.setFirstName(customer.getFirstName());
        updatedCustomer.setLastName(customer.getLastName());

        customerRepositoryDB.save(updatedCustomer);
